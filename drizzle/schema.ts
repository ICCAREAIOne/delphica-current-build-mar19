...
// ─────────────────────────────────────────────────────────────────────────────
// CPT CODES — CPT-4 reference table (8,222 codes from public CPT-4 dataset)
// Used to validate procedure codes generated by the Semantic Processor.
// ─────────────────────────────────────────────────────────────────────────────
export const cptCodes = mysqlTable('cpt_codes', {
  ...
  isCategoryIii: tinyint('is_category_iii').notNull().default(0),
  createdAt:    timestamp('created_at').defaultNow(),
});
